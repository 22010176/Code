...
def calculate_regression_params(prediction_list, target_list):
    ...
    return average_x, average_y, a, b, SSx, SSxy
...
def main():
    while True:
        ...
        mae, mse, rmse, SSR, SST, R1, R2 = calculate_metrics(
            prediction_list, target_list, a, b)
        print_metrics(prediction_list, target_list, a, b,
                      mae, mse, rmse, SSR, SST, R1, R2)
